...
const text = {
  en: {
    ...
    subtitle:
      "Complete your candidate profile. You will choose one skill for today's interview after registration.",
    name: "Full Name",
    ...
    skillsHint:
      "Select all skills you know. You will choose one skill for today's interview after registration.",
    selectedSkills: "Selected Skills:",
    selectedSkillsNote:
      "These represent your experience. You will choose one skill for today's interview on the next screen.",
  ...
  hi: {
    ...
    subtitle:
      "अपनी उम्मीदवार प्रोफाइल पूरी करें। रजिस्ट्रेशन के बाद आप आज के इंटरव्यू के लिए एक स्किल चुनेंगे।",
    name: "पूरा नाम",
    ...
    skillsHint:
      "जो-जो स्किल्स आपको आती हैं उन्हें चुनें। अगले स्क्रीन पर आप आज के इंटरव्यू के लिए एक स्किल चुनेंगे।",
    selectedSkills: "चुनी गई स्किल्स:",
    selectedSkillsNote:
      "ये आपकी अनुभव वाली स्किल्स हैं। अगले स्क्रीन पर आप आज के इंटरव्यू के लिए एक स्किल चुनेंगे।",
    create: "अकाउंट बनाएं",
  ...
  kn: {
    ...
    subtitle:
      "ನಿಮ್ಮ ಅಭ್ಯರ್ಥಿ ಪ್ರೊಫೈಲ್ ಪೂರ್ಣಗೊಳಿಸಿ. ನೋಂದಣಿ ನಂತರ ಇಂದಿನ ಸಂದರ್ಶನಕ್ಕಾಗಿ ಒಂದು ಕೌಶಲ್ಯವನ್ನು ಆಯ್ಕೆ ಮಾಡುತ್ತೀರಿ.",
    name: "ಪೂರ್ಣ ಹೆಸರು",
    ...
    skillsHint:
      "ನಿಮಗೆ ತಿಳಿದಿರುವ ಎಲ್ಲಾ ಕೌಶಲ್ಯಗಳನ್ನು ಆಯ್ಕೆಮಾಡಿ. ಮುಂದಿನ ಪರದೆಯಲ್ಲಿ ಇಂದಿನ ಸಂದರ್ಶನಕ್ಕಾಗಿ ಒಂದು ಕೌಶಲ್ಯವನ್ನು ಆಯ್ಕೆ ಮಾಡುತ್ತೀರಿ.",
    selectedSkills: "ಆಯ್ಕೆ ಮಾಡಿದ ಕೌಶಲ್ಯಗಳು:",
    selectedSkillsNote:
      "ಇವು ನಿಮ್ಮ ಅನುಭವವನ್ನು ಸೂಚಿಸುತ್ತವೆ. ಮುಂದಿನ ಪರದೆಯಲ್ಲಿ ಇಂದಿನ ಸಂದರ್ಶನಕ್ಕಾಗಿ ಒಂದು ಕೌಶಲ್ಯವನ್ನು ಆಯ್ಕೆ ಮಾಡುತ್ತೀರಿ.",
    create: "ಖಾತೆ ರಚಿಸಿ",
...
const errorText = {
  en: {
    ...
    aadharLength: "Aadhar number must be exactly 12 digits",
    aadharInvalid: "Aadhar number must contain only digits",
    aadharRepeated: "Invalid Aadhar number",
...
const Register: React.FC = () => {
  ...
  const validateField = (
    ...
    if (field === "phone") {
      ...
      if (!phone) return eText.phoneRequired;
  ...
  const isValidField = (field: keyof FormData) => {
    ...
    if (Array.isArray(value)) {
      return value.length > 0 && !errors[field];
    }
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setSubmitError(eText.submitFailed);
      }
    } finally {
      setIsLoading(false);
    }
                ...
                {skillOptions.map((skill) => (
                  <label
                    ...
                    className={`skill-checkbox ${
                      formData.skills.includes(skill) ? "skill-selected" : ""
                    }`}
                  >
                    <input
                      type="checkbox"
              ...
              {formData.skills.length > 0 && (
                <>
                  ...
                  <div className="profile-skill-note">
                    <strong>{t.selectedSkills}</strong> {t.selectedSkillsNote}
                  </div>
                </>
              )}
            </div>
